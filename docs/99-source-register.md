...
| SRC-005 | `docs/*.md`, `docs/reference/`, `prompts/marketing/` | P2 / MEDIUM | tài liệu thiết kế, hướng dẫn và prompt hỗ trợ |
| SRC-006 | `archive/reference/`, PDF/notebook học tập | P2/P3 | tài liệu tham khảo, không override nguồn canonical |
| SRC-007 | Google Classroom screenshots/user notes | REFERENCE_TO_CANONICAL | quy cách thư mục ZIP, mốc nộp |
| SRC-008 | `archive/legacy/`, dự án và báo cáo bán hàng | LEGACY | lịch sử; không dùng làm yêu cầu marketing |
