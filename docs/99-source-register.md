...
|---|---|---|---|
| SRC-001 | `source-materials/DỰ ÁN.png` / ảnh đề bài người dùng cung cấp | CANONICAL | tên đề tài, AIA331, 80300, requirements |
...
Nếu nội dung từ nguồn legacy khác đề bài ảnh, chọn `SRC-001` và ghi xung đột.
