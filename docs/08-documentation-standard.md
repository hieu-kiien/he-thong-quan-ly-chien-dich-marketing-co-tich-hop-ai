...
Kiểm tra bìa, tên đề tài, mã học phần, thành viên, số trang, mục lục, hình/bảng,
link tương đối, trạng thái `PROPOSED/OPEN`, mã nguồn chạy được, không secret và
ZIP có thể mở trên máy khác.
