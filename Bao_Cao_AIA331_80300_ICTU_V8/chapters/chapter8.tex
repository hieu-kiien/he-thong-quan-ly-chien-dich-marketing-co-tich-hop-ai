...
\begin{tabularx}{\textwidth}{L{4.0cm}L{3.1cm}Y}
\toprule
\textbf{Hạng mục} & \textbf{Hiện trạng} & \textbf{Việc cần làm tiếp theo}\\
\midrule
...
\toprule
\textbf{Nội dung trong thiết kế} & \textbf{Tài liệu cần bổ sung} & \textbf{Cách trình bày ở báo cáo cuối}\\
\midrule
