...
\hline
\thead{Phần} & \thead{Lựa chọn} & \thead{Lý do và điều kiện xem xét lại}\\
\hline
...
\hline
\thead{Thành phần} & \thead{Trách nhiệm} & \thead{Yêu cầu liên quan}\\
\hline
...
\label{tab:v8-api}
\begin{tabularx}{\textwidth}{|C{2.5cm}|L{5.0cm}|Y|}
\hline
\thead{Phương thức} & \thead{Đường dẫn} & \thead{Quy tắc}\\
\hline
...
\hline
\thead{Mã} & \thead{Quyết định} & \thead{Đánh đổi}\\
\hline
