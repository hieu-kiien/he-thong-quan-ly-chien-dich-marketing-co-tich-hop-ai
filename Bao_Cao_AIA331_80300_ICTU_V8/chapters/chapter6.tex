...
\toprule
\textbf{Công việc} & \textbf{AI được làm} & \textbf{AI không được làm}\\
\midrule
...
\toprule
\textbf{Chức năng} & \textbf{Dữ liệu được đưa vào} & \textbf{Dữ liệu loại trừ}\\
\midrule
...
\begin{tabularx}{\textwidth}{L{3.0cm}Y Y}
\toprule
\textbf{Trường hợp} & \textbf{Phản hồi của hệ thống} & \textbf{Cách kiểm tra}\\
\midrule
Quá thời gian & Dừng theo thời hạn; giữ bản nháp cũ và cho phép thử lại. & Giả lập timeout, ghi thời gian và trạng thái.\\
Giới hạn tốc độ & Thử lại với số lần giới hạn hoặc thông báo thử sau. & Giả lập mã 429 và kiểm tra không lặp vô hạn.\\
Kết quả sai cấu trúc & Không lưu thành bản nháp dùng được; hiển thị lỗi kiểm tra. & Dùng response thiếu trường hoặc sai kiểu.\\
Thông tin không có trong dữ liệu & Hiển thị cảnh báo để người dùng sửa hoặc bỏ. & Tạo case có thông tin bị bịa và chấm theo tiêu chí.\\
Yêu cầu quá dài & Rút gọn theo quy tắc và thông báo phần bị bỏ. & Ghi độ dài trước/sau và danh sách trường đã chọn.\\
Nhà cung cấp không hoạt động & Thông báo rõ; dùng phương án dự phòng nếu đã cấu hình. & Ngắt provider và kiểm tra dữ liệu cũ vẫn nguyên vẹn.\\
\bottomrule
\end{tabularx}
\end{table}
