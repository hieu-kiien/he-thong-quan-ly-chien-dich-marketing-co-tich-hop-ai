...
\small
\begin{longtable}{@{}L{2.3cm}L{2.5cm}L{2.8cm}L{6.4cm}@{}}
\caption{Các bảng và quy tắc cần giữ khi triển khai}\label{tab:v8-data-dictionary}\\
\toprule
\textbf{Bảng} & \textbf{Vai trò} & \textbf{Khóa} & \textbf{Quy tắc chính}\\
\midrule
\endfirsthead
\toprule
\textbf{Bảng} & \textbf{Vai trò} & \textbf{Khóa} & \textbf{Quy tắc chính}\\
...
\makecell[l]{\texttt{product\_}\\\texttt{categories}} & Nhóm sản phẩm & PK \texttt{id} & Tên duy nhất.\\
...
\makecell[l]{\texttt{campaign\_}\\\texttt{members}} & Phân công & PK campaign/user & Không lặp cặp chiến dịch--người dùng.\\
\makecell[l]{\texttt{marketing\_}\\\texttt{contents}} & Bản nội dung & \makecell[l]{PK; FK\\campaign,\\channel,\\user} & Trạng thái phải hợp lệ; có nguồn và cảnh báo nếu do AI tạo.\\
\makecell[l]{\texttt{content\_}\\\texttt{reviews}} & Lịch sử duyệt & PK; FK content/reviewer & Quyết định và lý do bắt buộc.\\
\makecell[l]{\texttt{marketing\_}\\\texttt{schedules}} & Lịch đăng & PK; FK content & Chỉ nội dung APPROVED; múi giờ bắt buộc.\\
\makecell[l]{\texttt{campaign\_}\\\texttt{metrics}} & Số liệu theo ngày/kênh & PK; FK campaign/channel & Duy nhất theo campaign--channel--date; số liệu không âm.\\
...
\begin{figure}[h!]
\centering
\input{figures/ui-wireframe.tex}
