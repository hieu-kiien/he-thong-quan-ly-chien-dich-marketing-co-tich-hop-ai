...
\hline
\thead{Actor} & \thead{Mục tiêu} & \thead{Giới hạn quyền}\\
\hline
...
\begin{tabularx}{\textwidth}{|C{1.1cm}|L{2.2cm}|L{4.5cm}|Y|}
\hline
\thead{Mã} & \thead{Nhóm} & \thead{Yêu cầu} & \thead{Điều kiện nghiệm thu dự kiến}\\
\hline
...
\begin{tabularx}{\textwidth}{|C{1.3cm}|L{2.2cm}|Y|Y|}
\hline
\thead{Mã} & \thead{Thuộc tính} & \thead{Tình huống cần xử lý} & \thead{Cách kiểm tra}\\
\hline
