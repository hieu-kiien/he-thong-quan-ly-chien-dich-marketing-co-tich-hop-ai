...
This project is indexed by GitNexus as **he-thong-quan-ly-chien-dich-marketing-co-tich-hop-ai** (698 symbols, 980 relationships, 42 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
